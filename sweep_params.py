...
for sigma_w in sigma_ws:
    out = f'/content/drive/MyDrive/ml_projects/orthogonal_transformer/orthogonal-transformer-scaled-layers-16-d-256-lr-3e-4/sigma_w_{sigma_w:g}'
